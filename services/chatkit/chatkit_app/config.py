...
DEFAULT_INSTRUCTIONS = (
    ...
    "Use sandbox_desktop_start to open a desktop when needed, and sandbox_python_run for code (language: python/go/js/rust).\n"
    "All code runs in Jupyter kernels (cell execution). Write code as a single notebook cell; state persists between runs.\n"
